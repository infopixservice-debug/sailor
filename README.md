...
**🌐 Live:** https://infopixservice-debug.github.io/sailor/

## Cosa include

- **🏴‍☠️ Crew Browser** — 20 sailor filtrabili per razza, location, tipo, con benefit score SMH/Barter
...
- **⚔️ Comparator** — confronto fianco a fianco fino a 4 sailor, preset Top 4 per obiettivo
...
- **⌨️ Scorciatoie tastiera:** `/` focus ricerca · `Esc` chiude modal · `1`–`7` cambia tab · `Ctrl+S` salva tracker · `Ctrl+E` esporta
